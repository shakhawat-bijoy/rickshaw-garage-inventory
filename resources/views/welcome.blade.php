...
<body class="bg-gray-50 mx-auto max-w-[1320px] mt-5 mb-10">
    ...
    <div class=" ">
        <!-- Header -->
        <div class="flex justify-between mb-10 bg-white shadow rounded-2xl p-6 text-center items-center">
            <div>
            ...
            <div class="mb-6">
                <div class="relative">
                    <input type="text" id="searchInput" placeholder="Search by item name, location, or status..."
                        class="w-full rounded-xl border border-gray-300 p-3 pl-10">
        ...
        <!-- Contact Us Section -->
        <section class="bg-white rounded-2xl shadow-lg p-8 mt-10">
            <div class="text-center mb-8">
                <h2 class="text-3xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-4">
                    Contact Us
                </h2>
                <p class="text-gray-600 max-w-2xl mx-auto">
                    Get in touch with us for any questions about our rickshaw garage management system.
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="space-y-6">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">
                                123 Rickshaw Street, Dhanmondi<br>
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">
                                info@rickshawgarage.com<br>
                                support@rickshawgarage.com
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center space-x-4 bg-gradient-to-r from-blue-50 to-purple-50 p-4 rounded-xl border border-blue-100">
                        <div class="flex-shrink-0">
                            <img src="https://ik.imagekit.io/abpj7jifz/1750155377729.jpg?updatedAt=1751082160346"
                                alt="Shakhawat Bijoy"
                                class="w-24 h-24 rounded-s-2xl object-cover border-2 border-blue-200 shadow-md">
                        </div>
                        <div class="flex-1">
                            <h3 class="text-sm font-medium text-gray-700 mb-1">Developed By:</h3>
                            <a href="https://shakhawat-bijoy.vercel.app/"
                                target="_blank"
                                class="text-lg font-bold text-gray-800 hover:text-blue-600 transition-colors duration-200 inline-flex items-center group">
                                Shakhawat Bijoy
                                <svg class="w-4 h-4 ml-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="flex space-x-4 mt-4">
                                ...
                                <a href="https://linkedin.com/in/shakhawat-bijoy" target="_blank" class="bg-blue-100 hover:bg-blue-200 text-blue-600 p-2 rounded-lg transition-colors duration-200">
                                    <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                                    </svg>
                                </a>
                                
                                <a href="https://www.facebook.com/bijoy1x" target="_blank" class="bg-blue-100 hover:bg-blue-200 text-blue-600 p-2 rounded-lg transition-colors duration-200">
                                    <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 rounded-xl p-6">
                        <h3 class="font-semibold text-gray-800 mb-4">Send us a Message</h3>
                        <form class="space-y-4">
                            ...
                            <button type="submit"
                                class="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white font-medium py-3 px-6 rounded-lg hover:from-blue-600 hover:to-purple-700 transition-all duration-300 transform hover:scale-105">
                                Send Message
                            </button>
                        </form>
                    </div>
                    ...
                    <div class="bg-gray-200 rounded-xl overflow-hidden h-64">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3651.9073032764486!2d90.37840931540226!3d23.750829994588673!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755bf4d91b5fa97%3A0x421a33b94ff7b199!2sDhanmondi%2032%2C%20Dhaka%201209%2C%20Bangladesh!5e0!3m2!1sen!2sus!4v1673234567890!5m2!1sen!2sus"
                            width="100%"
                            height="100%"
                            style="border:0;"
                            allowfullscreen=""
